...
public class TestController {
    ...
    public ResponseEntity<ApiResponse<TestResultDetailResponse>> getTestResultDetail(
        ...
        TestResultDetailResponse response = testService.getTestResultDetail(resultId);
    ...
    public ResponseEntity<ApiResponse<PaginationResponse<TestHistoryResponse>>> getTestHistoryByProfile(
        ...
        PaginationResponse<TestHistoryResponse> response = testService.getTestHistoryByProfile(profileId, page, size);
